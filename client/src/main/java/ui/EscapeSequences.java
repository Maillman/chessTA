...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_OFF_GREEN = SET_BG_COLOR + "28m";
    public static final String SET_BG_COLOR_OFF_LIGHT_GREEN = SET_BG_COLOR + "34m";
    ...
    public static final String SET_BG_COLOR_DARK_YELLOW = SET_BG_COLOR + "11m";
